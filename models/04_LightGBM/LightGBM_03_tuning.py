...
# -*- coding: utf-8 -*-
"""
[3] LightGBM 하이퍼파라미터 튜닝 및 상위 10개 결과 테이블 출력 스크립트
-------------------------------------------------------------------------
- 다양한 파라미터 조합을 순회하며 학습 및 검증을 진행.
- 각 조합별 파라미터 값과 성능 지표(Accuracy, ROC-AUC)를 수집.
- 검증 성능(ROC-AUC) 기준 상위 10개의 조합을 정렬된 테이블로 출력하고 CSV로 저장.
"""
