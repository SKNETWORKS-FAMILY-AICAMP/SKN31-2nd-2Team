...
### 4-1. 전체 모델 성능 비교표
<기본 전처리(음수값 0으로 변환, Label Encoding)>
| 순번 | 모델명 | Accuracy (정확도) | ROC-AUC | Precision (정밀도) | Recall (재현율) | F1-Score |
| :---: | :--- | :---: | :---: | :---: | :---: | :---: |
| **1** | **GradientBoosting** | 0.7515 | 0.8051 | 0.7200 | **0.7200** | **0.7200** |
| **2** | **LightGBM** | **0.7600** | **0.8263** | 0.6668 | 0.5515 | 0.6037 |
| **3** | **XGBoost** | 0.7082 | 0.7982 | 0.5483 | 0.6794 | 0.6068 |
| **4** | **딥러닝 (NN)** | 0.7400 | 0.7976 | 0.7100 | 0.7100 | 0.7100 |
| **5** | **랜덤포레스트** | **0.7600** | 0.8045 | **0.7300** | 0.7100 | **0.7200** |
---
<모델별 전처리 및 튜닝>
| 순번 | 모델명 | Accuracy (정확도) | ROC-AUC | Precision (정밀도) | Recall (재현율) | F1-Score |
| :---: | :--- | :---: | :---: | :---: | :---: | :---: |
...
| **4** | **딥러닝 (NN)** | 0.7500 | 0.8004 | 0.6300 | 0.5900 | 0.6100 |
| **5** | **랜덤포레스트** | **0.7600** | **0.8069** | **0.7300** | **0.7100** | **0.7200** |
